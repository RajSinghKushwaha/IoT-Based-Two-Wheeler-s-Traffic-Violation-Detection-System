...
area1_pointA = (160,350)
area1_pointB = (700,350)
area1_pointC = (60,400)
area1_pointD = (720,400)

start_area = [(180,140),(190,130),(740,180),(730,190)]
stop_area = [(60,300),(80,280),(720,340),(700,360)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='final.pt', help='model.pt path(s)')
